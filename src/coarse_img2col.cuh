#ifndef COARSE_MATRIX_KERNEL_IM2COL_CUH
#define COARSE_MATRIX_KERNEL_IM2COL_CUH
...
__global__ void CoarseMatrixKernelIm2colSplitImgKernel(
	...
	// __align__(16) __shared__ XFLOAT s_trans_real_mat_block[TParams::kTransBlockSize * TParams::kImgBlockSize];
	// __align__(16) __shared__ XFLOAT s_trans_imag_mat_block[TParams::kTransBlockSize * TParams::kImgBlockSize];
	// __align__(16) __shared__ XFLOAT s_orient_real_mat_block[TParams::kOrientBlockSize * TParams::kImgBlockSize];
	// __align__(16) __shared__ XFLOAT s_orient_imag_mat_block[TParams::kOrientBlockSize * TParams::kImgBlockSize];
...
# endif // COARSE_MATRIX_KERNEL_IM2COL_CUH
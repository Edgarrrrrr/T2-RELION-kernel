#ifndef COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_BCF_PMO_TMDB_NFUSE_NT_E_CUH
#define COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_BCF_PMO_TMDB_NFUSE_NT_E_CUH
...
__global__ void CoarseMatrixKernelIm2colSplitImgBCFProjOverlapTransDBNfuseNtEKernel(
	XFLOAT *g_eulers,
	XFLOAT *trans_x,
	XFLOAT *trans_y,
	XFLOAT *g_real,
...
struct CoarseMatrixKernelIm2colSplitImgBCFProjOverlapTransDBNfuseNtE {
  ...
  CoarseMatrixKernelIm2colSplitImgBCFProjOverlapTransDBNfuseNtE(
  ...
  void run(XFLOAT *g_eulers, 
    ...
    if constexpr (!std::is_same_v<TParams, void>) {
      ...
      CoarseMatrixKernelIm2colSplitImgBCFProjOverlapTransDBNfuseNtEKernel<TParams>
	  <<<grid, block, 0, stream>>>(
      ...
      dispatch_TParams([=](auto dummy) {
		...
		CoarseMatrixKernelIm2colSplitImgBCFProjOverlapTransDBNfuseNtEKernel<SelectedTParams><<<grid, block, 0, stream>>>(
            g_eulers, trans_x, trans_y, g_real, g_imag, projector, g_corr,
            g_diff2s, g_diff2s_dest, translation_num_, orientation_num_, image_size_, full_image_size_, g_coor_xy, work_space);
      });
    }
...
#endif //COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_BCF_PMO_TMDB_NFUSE_NT_E_CUH
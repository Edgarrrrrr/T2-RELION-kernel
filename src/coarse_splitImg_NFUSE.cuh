#ifndef COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_NFUSE_CUH
#define COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_NFUSE_CUH
...
__global__ void CoarseMatrixKernelIm2colSplitImgNfuseKernel(
	XFLOAT *g_eulers,
	XFLOAT *trans_x,
	XFLOAT *trans_y,
	XFLOAT *g_real,
...
struct CoarseMatrixKernelIm2colSplitImgNfuse {
  ...
  void run(XFLOAT *g_eulers, 
    ...
    if constexpr (!std::is_same_v<TParams, void>) {
      ...
      CoarseMatrixKernelIm2colSplitImgNfuseKernel<TParams>
	  <<<grid, block, 0, stream>>>(
      ...
      dispatch_TParams([=](auto dummy) {
		...
		CoarseMatrixKernelIm2colSplitImgNfuseKernel<SelectedTParams><<<grid, block, 0, stream>>>(
            g_eulers, trans_x, trans_y, g_real, g_imag, projector, g_corr,
            g_diff2s, g_diff2s_dest, translation_num_, orientation_num_, image_size_, full_image_size_, g_coor_xy);
      });
    }
...
#endif // COARSE_MATRIX_KERNEL_IM2COL_SPLITIMG_NFUSE_CUH